...
## Agent Protocol
- Workspace: `~/Projects`. Missing dimi20cen repo: clone `https://github.com/dimi20cen/<repo>.git`.
- 3rd-party/OSS (non-dimi20cen): clone under `~/Projects/oss`.
